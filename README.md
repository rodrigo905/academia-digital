Desenvolvimento de uma aplicação Restful usando Spring Data JPA e o banco de dados Postgres. Este projeto foi proposto no bootcamp da Carrefour na DIO.

Comandos para fazer as requisições (Requisições GET podem ser feitas em um navegador comum, já as POST foi utilizado o Postman):

Inclusão de alunos:

<ul>
<li>GET http://localhost:8080/alunos
<li>POST http://localhost:8080/alunos
</ul>

Avaliação física:

<ul>
<li>GET http://localhost:8080/alunos/avaliacoes/ {numero de id do aluno}
<li>POST http://localhost:8080/avaliacoes
</ul>

Matriculas:

<ul>
<li>GET http://localhost:8080/matriculas
<li>POST http://localhost:8080/matriculas
</ul>

Reparem que a porta 8080 foi a utilizada no projeto e pode ser alterada conforme a necessidade.

Link do repositório: https://github.com/cami-la/academia-digital

Abaixo a descrição do repositório original da professora Camila Cavalcante.
